...
export const initialApproach = async (): Promise<number> => {
    return new Promise((resolve, reject) => {
        ...
        inputStream
            ...
            .on('end', () => {
                ...
                resolve(processTime);  // ✅ Now it properly resolves after finishing
            })
            .on('error', (err) => reject(err)); // Handle errors properly
    });
};
